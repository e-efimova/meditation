...
class SingInViewController: UIViewController {
    ...
    @IBAction func singInAction( sender: UIButton) {
        ...
        guard inputPassword.text?.isEmpty == false && inputLogin.text?.isEmpty == false else { return showAlert(message: "Поля пустые")}
        ...
        AF.request(url, method: .post, parameters: param, encoder: JSONParameterEncoder.default).validate().responseJSON { response in code
